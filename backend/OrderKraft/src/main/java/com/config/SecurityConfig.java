    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/login", "/api/auth/forgot-password", "/api/auth/verify-otp","/supplier/add","/raw_material/add", "/orders/***","/order_items/***","/invoices/***", "/orders/status/{id}","/supplier_performance/***","/feedback***","/api/chat***").permitAll() // Public endpoints like login, register
